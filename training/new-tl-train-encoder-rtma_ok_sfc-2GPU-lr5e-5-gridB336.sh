...
#SBATCH -A fv3-cam
#SBATCH -J av-ok-sfc-2gpu-lr5e-5-gB336
#SBATCH -p u1-h100
#SBATCH -q gpuwf
#SBATCH -N 1
...
#SBATCH -t 24:00:00
#SBATCH -o new-aardvark-gpu-train-ok-2gpu-lr5e-5-gB336.%j.out
#SBATCH -e new-aardvark-gpu-train-ok-2gpu-lr5e-5-gB336.%j.err
...
output_dir="/scratch3/NCEPDEV/fv3-cam/Ting.Lei/aardvark-data/dr-rtma/OK-output-2gpu-lr5e-5-gridB336/"
