...
#SBATCH -t 40:30:00
#SBATCH -onew-aardvark-gpu-train.%j.out
#SBATCH -e new-aardvark-gpu-train.%j.err
...
cd $rundir
output_dir="/scratch3/NCEPDEV/fv3-cam/Ting.Lei/aardvark-data/dr-output-new/encoder/"
...
python ../aardvark/train_module.py \
  ...
  --time_freq 1D \
  --grid_config ../aardvark/grid_config.yaml \
  --int_x 256 \
  --int_y 128
