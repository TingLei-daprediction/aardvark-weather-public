...
#SBATCH -t 00:30:00
#SBATCH -o new-aardvark-gpu-infer_041023-ok.%j.out
#SBATCH -e new-aardvark-gpu-infer_041023-ok.%j.err

# -------- inference inputs: EDIT THESE TWO --------
# Analysis time T (UTC, on the 1H cadence, minute must be :00)
infer_time="2022-04-10T23:00"
# Trained checkpoint FILE (epoch_N), e.g. from the lr5e-5 run
checkpoint="/scratch3/NCEPDEV/fv3-cam/Ting.Lei/aardvark-data/dr-rtma/OK-output-3mon-lr5e-5-gridB336-warmstart/epoch_612"
# --------------------------------------------------
