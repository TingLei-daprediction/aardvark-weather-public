...
#SBATCH -t 12:00:00
#SBATCH -o new-3mon-aardvark-gpu-train-ok-2gpu-lr5e-5-gB336.%j.out
#SBATCH -e new-3mon-aardvark-gpu-train-ok-2gpu-lr5e-5-gB336.%j.err
...
output_dir="/scratch3/NCEPDEV/fv3-cam/Ting.Lei/aardvark-data/dr-rtma/OK-output-3mon-lr5e-5-gridB336/"
