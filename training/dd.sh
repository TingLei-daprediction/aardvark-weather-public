...
#SBATCH -t 12:00:00
#SBATCH -o dd-3mon-train-ok-2gpu-lr5e-5-gB336-warmstart.%j.out
#SBATCH -e dd-3mon-train-ok-2gpu-lr5e-5-gB336-warmstart.%j.err
...
source_output_dir="/scratch3/NCEPDEV/fv3-cam/Ting.Lei/aardvark-data/dr-rtma/OK-output-3mon-lr5e-5-gridB336/"
output_dir="/scratch3/NCEPDEV/fv3-cam/Ting.Lei/aardvark-data/dr-rtma/OK-output-3mon-lr5e-5-gridB336-warmstart/"
